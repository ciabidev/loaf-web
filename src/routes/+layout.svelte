<script lang="ts">
	...
	registerFlavor({
		...
		cssVariables: {
			'--loaf-surface': '#1e1e2e',
			'--loaf-text': '#cdd6f4',
			'--loaf-text-on-accent': '#1e1e2e',
			'--loaf-accent': '#89b4fa',
			'--loaf-accent-secondary': '#89b4fa',
			'--loaf-surface-secondary': '#181825',
			'--loaf-success': '#a6e3a1',
			'--loaf-warning': '#f9e2af',
			'--loaf-error': '#f38ba8',
			'--loaf-nav-bg': '#11111b',
			'--loaf-nav-hover-bg': '#313244',
			'--loaf-nav-highlight': '#cdd6f4',
			'--loaf-nav-active-highlight': '#11111b'
		}
	});
