...
- After adding or changing a UI component, prop, variant, interaction, or responsive behavior, update `src/routes/+page.svelte` in the same change.
- Add a focused example that visibly exercises the new behavior so the test page remains a complete component gallery and manual regression page.
- Edit the existing test page in place. Do not delete and recreate it.
- Keep examples concise and reuse the test page's existing sections, styles, and components when practical.
# Style Guide
